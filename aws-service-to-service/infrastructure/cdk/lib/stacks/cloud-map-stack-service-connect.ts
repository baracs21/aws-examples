...
export interface CloudMapServiceConnectStackProperties extends StackProps {
  vpc: IVpc
}

export class CloudMapServiceConnectStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: CloudMapServiceConnectStackProperties) {
    ...
    app1.service.enableServiceConnect({
      services: [
        {
          portMappingName: app1.portMappingName,
        },
      ],
    })
    ...
    app2.service.enableServiceConnect({
      services: [
        {
          portMappingName: app2.portMappingName,
        },
      ],
    })
