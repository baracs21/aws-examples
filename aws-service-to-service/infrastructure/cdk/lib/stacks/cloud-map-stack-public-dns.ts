...
export interface CloudMapPublicDnsStackProperties extends StackProps {
  vpc: IVpc
}

export class CloudMapPublicDnsStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props: CloudMapPublicDnsStackProperties) {
